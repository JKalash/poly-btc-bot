// @b5p/pair-execution/ledger — Balanced pair-specific journal generation and conservation checks.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-040 (§26).
