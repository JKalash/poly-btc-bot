// @b5p/pair-execution/settlement — Virtual merge and hold-to-resolution paper transitions.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-042 (§26).
