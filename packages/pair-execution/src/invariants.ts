// @b5p/pair-execution/invariants — Assertions run after every reduction and before commit.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-039 (§26).
