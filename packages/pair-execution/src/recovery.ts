// @b5p/pair-execution/recovery — Compute permitted paper alternatives without choosing from future data.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-041 (§26).
