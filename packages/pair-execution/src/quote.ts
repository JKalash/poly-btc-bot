// @b5p/pair-execution/quote — Exact per-level direct BUY and SELL quotes, including fee convention.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-033 / BPAIR-034 (§26).
