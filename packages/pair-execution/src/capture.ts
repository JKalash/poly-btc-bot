// @b5p/pair-execution/capture — Immutable capture construction and temporal/integrity validation.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-032 (§26).
