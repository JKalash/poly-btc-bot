// @b5p/pair-execution/reconciliation — Compare events, projection, ledger, reservations, and adapter state.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-043 (§26).
