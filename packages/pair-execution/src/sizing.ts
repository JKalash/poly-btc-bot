// @b5p/pair-execution/sizing — Candidate frontier generation and largest-valid-prefix selection.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-035 (§26).
