// @b5p/pair-execution/ids — Deterministic group, leg, order-client, event, and idempotency keys.
// Owning spec: docs/research/mrfadiai-polymarket-bot-borrow-implementation-spec.md §10.1 (file responsibilities); implementing task: BPAIR-031 (§26).
